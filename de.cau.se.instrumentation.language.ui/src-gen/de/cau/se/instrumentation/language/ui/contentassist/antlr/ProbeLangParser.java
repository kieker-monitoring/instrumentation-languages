...
* generated by Xtext
*/
package de.cau.se.instrumentation.language.ui.contentassist.antlr;
...
public class ProbeLangParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.se.instrumentation.language.ui.contentassist.antlr.internal.InternalProbeLangParser createParser() {
		de.cau.se.instrumentation.language.ui.contentassist.antlr.internal.InternalProbeLangParser result = new de.cau.se.instrumentation.language.ui.contentassist.antlr.internal.InternalProbeLangParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRecordDeclarationAccess().getGroup(), "rule__RecordDeclaration__Group__0");
					put(grammarAccess.getPropertyAccess().getGroup(), "rule__Property__Group__0");
					put(grammarAccess.getReplacementAccess().getGroup(), "rule__Replacement__Group__0");
					...
					put(grammarAccess.getPatternCallAccess().getGroup_3(), "rule__PatternCall__Group_3__0");
					put(grammarAccess.getStringElementAccess().getGroup(), "rule__StringElement__Group__0");
					put(grammarAccess.getScopeRefElementAccess().getGroup(), "rule__ScopeRefElement__Group__0");
					...
					put(grammarAccess.getImportAccess().getEPackageAssignment_1(), "rule__Import__EPackageAssignment_1");
					...
					put(grammarAccess.getPatternAccess().getParametersAssignment_3(), "rule__Pattern__ParametersAssignment_3");
					put(grammarAccess.getPatternAccess().getParametersAssignment_4_1(), "rule__Pattern__ParametersAssignment_4_1");
					put(grammarAccess.getPatternAccess().getCodeSequceneAssignment_6(), "rule__Pattern__CodeSequceneAssignment_6");
					...
					put(grammarAccess.getProbeAccess().getRecordAssignment_3(), "rule__Probe__RecordAssignment_3");
					put(grammarAccess.getProbeAccess().getReplacementsAssignment_4(), "rule__Probe__ReplacementsAssignment_4");
					put(grammarAccess.getRecordDeclarationAccess().getPropertiesAssignment_2(), "rule__RecordDeclaration__PropertiesAssignment_2");
					...
					put(grammarAccess.getReplacementAccess().getNameAssignment_0(), "rule__Replacement__NameAssignment_0");
					put(grammarAccess.getReplacementAccess().getScopeAssignment_1(), "rule__Replacement__ScopeAssignment_1");
					put(grammarAccess.getReplacementAccess().getPatternsAssignment_3(), "rule__Replacement__PatternsAssignment_3");
					put(grammarAccess.getScopeAccess().getModelRefAssignment_1(), "rule__Scope__ModelRefAssignment_1");
					put(grammarAccess.getScopeAccess().getInsertBeforeAssignment_2(), "rule__Scope__InsertBeforeAssignment_2");
					put(grammarAccess.getScopeAccess().getTargetAssignment_3(), "rule__Scope__TargetAssignment_3");
					put(grammarAccess.getScopeAccess().getInsertAfterAssignment_4(), "rule__Scope__InsertAfterAssignment_4");
					put(grammarAccess.getAlternativeAccess().getOrExprAssignment_0(), "rule__Alternative__OrExprAssignment_0");
					put(grammarAccess.getAlternativeAccess().getOrExprAssignment_1_1(), "rule__Alternative__OrExprAssignment_1_1");
					put(grammarAccess.getSequenceAccess().getAndExprAssignment(), "rule__Sequence__AndExprAssignment");
					put(grammarAccess.getQuantifierAccess().getItemAssignment_0(), "rule__Quantifier__ItemAssignment_0");
					put(grammarAccess.getQuantifierAccess().getTypeAssignment_1(), "rule__Quantifier__TypeAssignment_1");
					put(grammarAccess.getOperatorAccess().getTypeAssignment(), "rule__Operator__TypeAssignment");
					put(grammarAccess.getGroupAccess().getSubTargetAssignment_1(), "rule__Group__SubTargetAssignment_1");
					put(grammarAccess.getPatternCallAccess().getRefAssignment_0(), "rule__PatternCall__RefAssignment_0");
					put(grammarAccess.getPatternCallAccess().getValuesAssignment_2(), "rule__PatternCall__ValuesAssignment_2");
					put(grammarAccess.getPatternCallAccess().getValuesAssignment_3_1(), "rule__PatternCall__ValuesAssignment_3_1");
					put(grammarAccess.getValueAccess().getElementsAssignment(), "rule__Value__ElementsAssignment");
					put(grammarAccess.getStringElementAccess().getToUpperAssignment_0(), "rule__StringElement__ToUpperAssignment_0");
					put(grammarAccess.getStringElementAccess().getValueAssignment_1(), "rule__StringElement__ValueAssignment_1");
					put(grammarAccess.getPropertyReferenceAccess().getRefAssignment(), "rule__PropertyReference__RefAssignment");
					put(grammarAccess.getScopeRefElementAccess().getRefAssignment_1(), "rule__ScopeRefElement__RefAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.se.instrumentation.language.ui.contentassist.antlr.internal.InternalProbeLangParser typedParser = (de.cau.se.instrumentation.language.ui.contentassist.antlr.internal.InternalProbeLangParser) parser;
