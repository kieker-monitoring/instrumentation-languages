...
package kieker::common::record::flow::AbstractEvent;
...
=head1 SYNOPSIS
 ...
 my $record = kieker::common::record::flow::AbstractEvent->new($timestamp);
...
=head2 $record = kieker::common::record::flow::AbstractEvent->new($timestamp);
