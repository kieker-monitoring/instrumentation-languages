 ...
 * generated by Xtext
 */
package kieker.tools.rl.ui.internal;
...
public class RecordLangActivator extends AbstractUIPlugin {
	...
	public static final String DE_CAU_CS_SE_INSTRUMENTATION_RL_RECORDLANG = "kieker.tools.rl.RecordLang";
	...
	protected Module getRuntimeModule(String grammar) {
		if (DE_CAU_CS_SE_INSTRUMENTATION_RL_RECORDLANG.equals(grammar)) {
			return new kieker.tools.rl.RecordLangRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (DE_CAU_CS_SE_INSTRUMENTATION_RL_RECORDLANG.equals(grammar)) {
			return new kieker.tools.rl.ui.RecordLangUiModule(this);
		}
