		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProbeAccess().getGroup_2_1(), "rule__Probe__Group_2_1__0");
					put(grammarAccess.getProbeAccess().getGroup_2_1_1(), "rule__Probe__Group_2_1_1__0");
					...
					put(grammarAccess.getModelAccess().getProbesAssignment_5_0(), "rule__Model__ProbesAssignment_5_0");
					put(grammarAccess.getModelAccess().getAspectsAssignment_5_1(), "rule__Model__AspectsAssignment_5_1");
					...
					put(grammarAccess.getAspectAccess().getProbeAssignment_2(), "rule__Aspect__ProbeAssignment_2");
					put(grammarAccess.getAspectAccess().getQueryAssignment_4(), "rule__Aspect__QueryAssignment_4");
					put(grammarAccess.getProbeAccess().getNameAssignment_1(), "rule__Probe__NameAssignment_1");
					put(grammarAccess.getProbeAccess().getParameterDeclarationsAssignment_2_1_0(), "rule__Probe__ParameterDeclarationsAssignment_2_1_0");
					put(grammarAccess.getProbeAccess().getParameterDeclarationsAssignment_2_1_1_1(), "rule__Probe__ParameterDeclarationsAssignment_2_1_1_1");
					put(grammarAccess.getProbeAccess().getCollectorsAssignment_4(), "rule__Probe__CollectorsAssignment_4");
					...
					put(grammarAccess.getQueryAccess().getMethodAssignment_1(), "rule__Query__MethodAssignment_1");
					...
					put(grammarAccess.getMethodQueryAccess().getParameterAssignment_4(), "rule__MethodQuery__ParameterAssignment_4");
					put(grammarAccess.getMethodQueryAccess().getParameterAssignment_5_1(), "rule__MethodQuery__ParameterAssignment_5_1");
