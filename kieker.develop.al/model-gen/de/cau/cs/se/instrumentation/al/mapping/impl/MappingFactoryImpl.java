...
public class MappingFactoryImpl extends EFactoryImpl implements MappingFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MappingPackage.TYPE: return createType();
			case MappingPackage.COLLECTION_TYPE: return createCollectionType();
			case MappingPackage.NAMED_TYPE: return createNamedType();
			case MappingPackage.TYPE_REFERENCE: return createTypeReference();
			case MappingPackage.CONTAINER: return createContainer();
			case MappingPackage.OPERATION: return createOperation();
			case MappingPackage.PARAMETER_MODIFIER: return createParameterModifier();
			...
			case MappingPackage.OPERATION_MODIFIER: return createOperationModifier();
			case MappingPackage.CONTAINER_MODIFIER: return createContainerModifier();
			case MappingPackage.ATTRIBUTE: return createAttribute();
			case MappingPackage.REFERENCE: return createReference();
			default:
	 ...
	 * @generated
	 */
	public kieker.develop.al.mapping.Container createContainer() {
