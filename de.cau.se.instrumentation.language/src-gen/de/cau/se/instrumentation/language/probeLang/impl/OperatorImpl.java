 ...
 * <ul>
 *   <li>{@link de.cau.se.instrumentation.language.probeLang.impl.OperatorImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperatorImpl extends ItemImpl implements Operator
{
   ...
   * @ordered
   */
  protected static final OperatorType TYPE_EDEFAULT = OperatorType.ANY_CHAR;
  ...
  {
    return ProbeLangPackage.Literals.OPERATOR;
  }
  ...
  public void setType(OperatorType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProbeLangPackage.OPERATOR__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProbeLangPackage.OPERATOR__TYPE:
        return getType();
    }
