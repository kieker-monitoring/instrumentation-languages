 ...
 * </p>
 * <ul>
 *   <li>{@link kieker.tools.al.aspectLang.UtilizeAdvice#getAdvice <em>Advice</em>}</li>
 *   <li>{@link kieker.tools.al.aspectLang.UtilizeAdvice#getParameterAssignments <em>Parameter Assignments</em>}</li>
 * </ul>
 *
 * @see kieker.tools.al.aspectLang.AspectLangPackage#getUtilizeAdvice()
 * @model
 * @generated
 */
public interface UtilizeAdvice extends EObject
{
   ...
   * @see kieker.tools.al.aspectLang.AspectLangPackage#getUtilizeAdvice_Advice()
   * @model
   * @generated
   */
  Advice getAdvice();
  ...
  /**
   * Sets the value of the '{@link kieker.tools.al.aspectLang.UtilizeAdvice#getAdvice <em>Advice</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see kieker.tools.al.aspectLang.AspectLangPackage#getUtilizeAdvice_ParameterAssignments()
