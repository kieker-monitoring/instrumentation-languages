		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLoadMetaModelAccess().getNameAssignment_1(), "rule__LoadMetaModel__NameAssignment_1");
					put(grammarAccess.getLoadMetaModelAccess().getEPackageAssignment_2(), "rule__LoadMetaModel__EPackageAssignment_2");
