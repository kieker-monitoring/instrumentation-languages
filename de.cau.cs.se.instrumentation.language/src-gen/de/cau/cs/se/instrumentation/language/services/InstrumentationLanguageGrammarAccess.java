...
* generated by Xtext
*/
package de.cau.cs.se.instrumentation.language.services;
...
@Singleton
public class InstrumentationLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cRecordsAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cRecordsRecordParserRuleCall_5_0 = (RuleCall)cRecordsAssignment_5.eContents().get(0);
		
		//Model:
		//	"package" name=QualifiedName packages+=Package* imports+=Import* patterns+=Pattern* records+=Record*;
		...
		//records+=Record*
		public Assignment getRecordsAssignment_5() { return cRecordsAssignment_5; }

		//Record
		public RuleCall getRecordsRecordParserRuleCall_5_0() { return cRecordsRecordParserRuleCall_5_0; }
	}
	...
	public class RecordElements extends AbstractParserRuleElementFinder {
		...
		//Record:
		//	"record" name=ID "{" properties+=Property* "}";
		public ParserRule getRule() { return rule; }
	...
	@Inject
	public InstrumentationLanguageGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.cau.cs.se.instrumentation.language.InstrumentationLanguage".equals(grammar.getName())) {
				return grammar;
			}
