		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropertyAccess().getPropertiesAssignment_4_0_1(), "rule__Property__PropertiesAssignment_4_0_1");
					put(grammarAccess.getPropertyAccess().getValueAssignment_4_1_1(), "rule__Property__ValueAssignment_4_1_1");
