...
public class RecordLangParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected kieker.develop.rl.parser.antlr.internal.InternalRecordLangParser createParser(XtextTokenStream stream) {
		return new kieker.develop.rl.parser.antlr.internal.InternalRecordLangParser(stream, getGrammarAccess());
	}
