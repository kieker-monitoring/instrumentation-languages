 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.instrumentation.language.instrumentation.impl.ReferencePropertyImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link de.cau.cs.se.instrumentation.language.instrumentation.impl.ReferencePropertyImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferencePropertyImpl extends MinimalEObjectImpl.Container implements ReferenceProperty
{
  ...
  {
    return InstrumentationPackage.Literals.REFERENCE_PROPERTY;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, InstrumentationPackage.REFERENCE_PROPERTY__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(EStructuralFeature newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InstrumentationPackage.REFERENCE_PROPERTY__REF, oldRef, ref));
  }
  ...
  public EList<ReferenceProperty> getProperties()
  {
    if (properties == null)
    {
      properties = new EObjectContainmentEList<ReferenceProperty>(ReferenceProperty.class, this, InstrumentationPackage.REFERENCE_PROPERTY__PROPERTIES);
    }
    return properties;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case InstrumentationPackage.REFERENCE_PROPERTY__PROPERTIES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case InstrumentationPackage.REFERENCE_PROPERTY__REF:
