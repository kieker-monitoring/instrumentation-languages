...
package kieker::common::record::misc::EmptyRecord;
...
=head1 SYNOPSIS
 ...
 my $record = kieker::common::record::misc::EmptyRecord->new();
...
=head2 $record = kieker::common::record::misc::EmptyRecord->new();
