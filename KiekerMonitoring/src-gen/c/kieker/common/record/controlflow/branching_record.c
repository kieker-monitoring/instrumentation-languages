...
#include <stdlib.h>
#include <kieker.h>
#include "c/kieker/common/record/controlflow/kieker_common_record_controlflow_branching_record.h"
...
int kieker_common_record_controlflow_branching_record_serialize(char *buffer, const int id, const int offset, const kieker_common_record_controlflow_branching_record value) {
	...
	length += kieker_serialize_int32(buffer,offset,branchID);
	length += kieker_serialize_int32(buffer,offset,branchingOutcome);
	return length;
}
