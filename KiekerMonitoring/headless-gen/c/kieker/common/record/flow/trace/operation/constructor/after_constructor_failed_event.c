...
#include <stdlib.h>
#include <kieker.h>
#include "c/kieker/common/record/flow/trace/operation/constructor/kieker_common_record_flow_trace_operation_constructor_after_constructor_failed_event.h"
