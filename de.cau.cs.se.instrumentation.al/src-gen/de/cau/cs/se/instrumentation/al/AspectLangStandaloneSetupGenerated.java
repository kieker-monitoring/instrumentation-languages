...
public class AspectLangStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new kieker.tools.al.AspectLangRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.cau.de/cs/se/instrumentation/al/AspectLang")) {
		EPackage.Registry.INSTANCE.put("http://www.cau.de/cs/se/instrumentation/al/AspectLang", kieker.tools.al.aspectLang.AspectLangPackage.eINSTANCE);
	}
