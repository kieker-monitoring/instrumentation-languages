 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see analysismodel.sources.SourcesFactory
 * @model kind="package"
 * @generated
 */
public interface SourcesPackage extends EPackage {
	 ...
	 * @generated
	 */
	SourcesPackage eINSTANCE = analysismodel.sources.impl.SourcesPackageImpl.init();

	/**
	 * The meta object id for the '{@link analysismodel.sources.impl.SourceModelImpl <em>Source Model</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see analysismodel.sources.impl.SourceModelImpl
	 * @see analysismodel.sources.impl.SourcesPackageImpl#getSourceModel()
	 * @generated
	 */
	int SOURCE_MODEL = 0;
	...
	/**
	 * The meta object id for the '{@link analysismodel.sources.impl.EObjectToSourcesEntryImpl <em>EObject To Sources Entry</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see analysismodel.sources.impl.EObjectToSourcesEntryImpl
	 * @see analysismodel.sources.impl.SourcesPackageImpl#getEObjectToSourcesEntry()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link analysismodel.sources.SourceModel <em>Source Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Source Model</em>'.
	 * @see analysismodel.sources.SourceModel
	 * @generated
	 */
	EClass getSourceModel();

	/**
	 * Returns the meta object for the map '{@link analysismodel.sources.SourceModel#getSources <em>Sources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the map '<em>Sources</em>'.
	 * @see analysismodel.sources.SourceModel#getSources()
	 * @see #getSourceModel()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link analysismodel.sources.impl.SourceModelImpl <em>Source Model</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see analysismodel.sources.impl.SourceModelImpl
		 * @see analysismodel.sources.impl.SourcesPackageImpl#getSourceModel()
		...
		/**
		 * The meta object literal for the '{@link analysismodel.sources.impl.EObjectToSourcesEntryImpl <em>EObject To Sources Entry</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see analysismodel.sources.impl.EObjectToSourcesEntryImpl
		 * @see analysismodel.sources.impl.SourcesPackageImpl#getEObjectToSourcesEntry()
