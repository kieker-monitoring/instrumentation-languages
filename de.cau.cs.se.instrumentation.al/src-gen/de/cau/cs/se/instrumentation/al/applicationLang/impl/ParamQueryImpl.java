 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.instrumentation.al.applicationLang.impl.ParamQueryImpl#getQueries <em>Queries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParamQueryImpl extends MinimalEObjectImpl.Container implements ParamQuery
{
  ...
  {
    return ApplicationLangPackage.Literals.PARAM_QUERY;
  }
  ...
  public EList<ParamCompare> getQueries()
  {
    if (queries == null)
    {
      queries = new EObjectContainmentEList<ParamCompare>(ParamCompare.class, this, ApplicationLangPackage.PARAM_QUERY__QUERIES);
    }
    return queries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ApplicationLangPackage.PARAM_QUERY__QUERIES:
