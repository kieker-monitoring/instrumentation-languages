 ...
 *   <li>{@link de.cau.cs.se.instrumentation.language.instrumentation.impl.ModelImpl#getProbes <em>Probes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  public EList<Probe> getProbes()
  {
    if (probes == null)
    {
      probes = new EObjectContainmentEList<Probe>(Probe.class, this, InstrumentationPackage.MODEL__PROBES);
    }
    return probes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case InstrumentationPackage.MODEL__PROBES:
