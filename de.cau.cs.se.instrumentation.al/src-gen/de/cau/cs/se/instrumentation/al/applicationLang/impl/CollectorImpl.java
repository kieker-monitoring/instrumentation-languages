 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.instrumentation.al.applicationLang.impl.CollectorImpl#getInsertionPoint <em>Insertion Point</em>}</li>
 *   <li>{@link de.cau.cs.se.instrumentation.al.applicationLang.impl.CollectorImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.se.instrumentation.al.applicationLang.impl.CollectorImpl#getInitializations <em>Initializations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectorImpl extends MinimalEObjectImpl.Container implements Collector
{
  ...
  {
    return ApplicationLangPackage.Literals.COLLECTOR;
  }
  ...
  public void setInsertionPoint(InsertionPoint newInsertionPoint)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApplicationLangPackage.COLLECTOR__INSERTION_POINT, oldInsertionPoint, insertionPoint));
  }
  ...
  public RecordType getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApplicationLangPackage.COLLECTOR__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(RecordType newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApplicationLangPackage.COLLECTOR__TYPE, oldType, type));
  }
  ...
  public EList<Value> getInitializations()
  {
    ...
    {
      initializations = new EObjectContainmentEList<Value>(Value.class, this, ApplicationLangPackage.COLLECTOR__INITIALIZATIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ApplicationLangPackage.COLLECTOR__INITIALIZATIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ApplicationLangPackage.COLLECTOR__INSERTION_POINT:
        return getInsertionPoint();
      case ApplicationLangPackage.COLLECTOR__TYPE:
