 ...
 * 
 */
public class RLOutputConfigurationProvider implements IOutputConfigurationProvider {

	/**
	 * Empty constructor.
	 */
	public RLOutputConfigurationProvider() {}
	...
	private OutputConfiguration createOutputConfiguration(final String type, final String description, final String folder) {
		final OutputConfiguration defaultOutputConfiguration = new RecordLangOutputConfiguration(type);
