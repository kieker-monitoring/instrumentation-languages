/**
 */
package analysismodel.trace.impl;

import analysismodel.deployment.DeployedOperation;

import analysismodel.trace.OperationCall;
 ...
 * </p>
 * <ul>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getStart <em>Start</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getDurRatioToParent <em>Dur Ratio To Parent</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getDurRatioToRootParent <em>Dur Ratio To Root Parent</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getStackDepth <em>Stack Depth</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getOrderIndex <em>Order Index</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#isFailed <em>Failed</em>}</li>
 *   <li>{@link analysismodel.trace.impl.OperationCallImpl#getFailedCause <em>Failed Cause</em>}</li>
 * </ul>
 *
 * @generated
 */
