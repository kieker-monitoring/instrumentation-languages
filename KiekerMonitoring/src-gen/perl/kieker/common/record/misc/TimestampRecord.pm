...
package kieker::common::record::misc::TimestampRecord;
...
=head1 SYNOPSIS
 ...
 my $record = kieker::common::record::misc::TimestampRecord->new($timestamp);
...
=head2 $record = kieker::common::record::misc::TimestampRecord->new($timestamp);
