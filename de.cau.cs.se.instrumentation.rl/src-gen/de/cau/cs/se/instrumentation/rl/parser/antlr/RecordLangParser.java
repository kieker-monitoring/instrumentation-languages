...
public class RecordLangParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected de.cau.cs.se.instrumentation.rl.parser.antlr.internal.InternalRecordLangParser createParser(XtextTokenStream stream) {
		return new de.cau.cs.se.instrumentation.rl.parser.antlr.internal.InternalRecordLangParser(stream, getGrammarAccess());
	}
