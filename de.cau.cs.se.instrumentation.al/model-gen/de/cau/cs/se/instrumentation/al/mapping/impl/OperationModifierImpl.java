 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.se.instrumentation.al.mapping.impl.OperationModifierImpl#getPredecessor <em>Predecessor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationModifierImpl extends NamedElementImpl implements OperationModifier {
	...
	protected EClass eStaticClass() {
		return MappingPackage.Literals.OPERATION_MODIFIER;
	}
		...
		if (predecessor != null && predecessor.eIsProxy()) {
			...
			if (predecessor != oldPredecessor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingPackage.OPERATION_MODIFIER__PREDECESSOR, oldPredecessor, predecessor));
			}
		}
		return predecessor;
	}
	...
	public void setPredecessor(EObject newPredecessor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.OPERATION_MODIFIER__PREDECESSOR, oldPredecessor, predecessor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingPackage.OPERATION_MODIFIER__PREDECESSOR:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Traceability.class) {
			switch (derivedFeatureID) {
				case MappingPackage.OPERATION_MODIFIER__PREDECESSOR: return MappingPackage.TRACEABILITY__PREDECESSOR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Traceability.class) {
			switch (baseFeatureID) {
				case MappingPackage.TRACEABILITY__PREDECESSOR: return MappingPackage.OPERATION_MODIFIER__PREDECESSOR;
				default: return -1;
			}
		}
