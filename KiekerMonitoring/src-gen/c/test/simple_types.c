...
#include <stdlib.h>
#include <kieker.h>
#include "c/test/test_simple_types.h"
 ...
 */
/*
 * Serialize an SimpleTypes and return the size of the written structure.
 *
 ...
 */
int test_simple_types_serialize(char *buffer, const int id, const int offset, const test_simple_types value) {
	int length = 0;
