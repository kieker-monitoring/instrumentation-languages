...
package kieker::common::record::misc::RegistryRecord;
...
=head1 SYNOPSIS
 ...
 my $record = kieker::common::record::misc::RegistryRecord->new($id, $string);
...
=head2 $record = kieker::common::record::misc::RegistryRecord->new($id, $string);
