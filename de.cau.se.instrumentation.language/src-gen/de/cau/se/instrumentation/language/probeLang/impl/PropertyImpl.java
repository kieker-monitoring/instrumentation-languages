...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property
{
   ...
   * @ordered
   */
  protected DataTypeDeclaration type;
   ...
   * @generated
   */
  public DataTypeDeclaration getType()
  {
    if (type != null && type.eIsProxy())
    {
      InternalEObject oldType = (InternalEObject)type;
      type = (DataTypeDeclaration)eResolveProxy(oldType);
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProbeLangPackage.PROPERTY__TYPE, oldType, type));
      }
    }
    return type;
  }
   ...
   * @generated
   */
  public DataTypeDeclaration basicGetType()
  {
    return type;
  }
   ...
   * @generated
   */
  public void setType(DataTypeDeclaration newType)
  {
    DataTypeDeclaration oldType = type;
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProbeLangPackage.PROPERTY__TYPE, oldType, type));
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case ProbeLangPackage.PROPERTY__TYPE:
        setType((DataTypeDeclaration)newValue);
        return;
      case ProbeLangPackage.PROPERTY__NAME:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case ProbeLangPackage.PROPERTY__TYPE:
        setType((DataTypeDeclaration)null);
        return;
      case ProbeLangPackage.PROPERTY__NAME:
