...
public class InstrumentationLanguageGenerator implements IGenerator {
  public void doGenerate(final Resource resource, final IFileSystemAccess fsa) {
    ...
    Iterable<Probe> _filter = Iterables.<Probe>filter(_iterable, Probe.class);
    for (final Probe e : _filter) {
  ...
  public CharSequence compile(final Probe probe) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package ");
    EObject _eContainer = probe.eContainer();
    String _name = ((Model) _eContainer).getName();
    ...
    _builder.append("\t    ");
    {
      EList<Property> _properties = probe.getProperties();
    ...
    _builder.append("\t");
    {
      EList<Property> _properties_1 = probe.getProperties();
    ...
    _builder.append("\t");
    {
      EList<Property> _properties_2 = probe.getProperties();
    ...
    String _name_2 = probe.getName();
    String _firstUpper_1 = StringExtensions.toFirstUpper(_name_2);
    _builder.append(_firstUpper_1, "	");
    _builder.append("Record (");
    {
      EList<Property> _properties_3 = probe.getProperties();
    ...
    _builder.append("\t\t");
    {
      EList<Property> _properties_4 = probe.getProperties();
    ...
    _builder.append("\t    ");
    {
      EList<Property> _properties_5 = probe.getProperties();
      for(final Property property_5 : _properties_5) {
        EList<Property> _properties_6 = probe.getProperties();
    ...
    _builder.append("\t\t    ");
    {
      EList<Property> _properties_7 = probe.getProperties();
