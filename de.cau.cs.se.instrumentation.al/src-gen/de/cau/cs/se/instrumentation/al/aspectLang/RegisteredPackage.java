...
public interface RegisteredPackage extends EObject
{
   ...
   * @see #setName(String)
   * @see de.cau.cs.se.instrumentation.al.aspectLang.AspectLangPackage#getRegisteredPackage_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.se.instrumentation.al.aspectLang.RegisteredPackage#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.se.instrumentation.al.aspectLang.AspectLangPackage#getRegisteredPackage_EPackage()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.se.instrumentation.al.aspectLang.RegisteredPackage#getEPackage <em>EPackage</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
