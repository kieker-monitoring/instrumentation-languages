 ...
 * <ul>
 *   <li>{@link de.cau.se.instrumentation.language.probeLang.impl.PatternImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.se.instrumentation.language.probeLang.impl.PatternImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link de.cau.se.instrumentation.language.probeLang.impl.PatternImpl#getCodeSequcene <em>Code Sequcene</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PatternImpl extends MinimalEObjectImpl.Container implements Pattern
{
  ...
  {
    return ProbeLangPackage.Literals.PATTERN;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProbeLangPackage.PATTERN__NAME, oldName, name));
  }
  ...
  public EList<Parameter> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, ProbeLangPackage.PATTERN__PARAMETERS);
    }
    return parameters;
  }
  ...
  public EList<CodeElement> getCodeSequcene()
  {
    ...
    {
      codeSequcene = new EObjectContainmentEList<CodeElement>(CodeElement.class, this, ProbeLangPackage.PATTERN__CODE_SEQUCENE);
    }
    return codeSequcene;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProbeLangPackage.PATTERN__PARAMETERS:
        return ((InternalEList<?>)getParameters()).basicRemove(otherEnd, msgs);
      case ProbeLangPackage.PATTERN__CODE_SEQUCENE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProbeLangPackage.PATTERN__NAME:
        return getName();
      case ProbeLangPackage.PATTERN__PARAMETERS:
