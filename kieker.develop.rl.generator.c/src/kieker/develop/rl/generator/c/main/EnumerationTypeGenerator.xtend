...
/**
 * Generator for enumeration types producing the serialization function for C.
 * 
 * @author Reiner Jung
 * @since 1.3
 */
class EnumerationTypeGenerator extends AbstractTypeGenerator<EventType, CharSequence> {
