...
public class RecordLangStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new kieker.tools.rl.RecordLangRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.cau.de/cs/se/instrumentation/rl/RecordLang")) {
		EPackage.Registry.INSTANCE.put("http://www.cau.de/cs/se/instrumentation/rl/RecordLang", kieker.tools.rl.recordLang.RecordLangPackage.eINSTANCE);
	}
