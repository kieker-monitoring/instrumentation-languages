...
package kieker::common::record::flow::trace::AbstractTraceEvent;
...
=head1 SYNOPSIS
 ...
 my $record = kieker::common::record::flow::trace::AbstractTraceEvent->new($timestamp, $traceId, $orderIndex);
...
=head2 $record = kieker::common::record::flow::trace::AbstractTraceEvent->new($timestamp, $traceId, $orderIndex);
