...
package test::DynamicArrayTypes;

=head1 NAME

test::DynamicArrayTypes 

=head1 SYNOPSIS

 my $record = test::DynamicArrayTypes->new($a, $b, $c, $d, $f, $g, $h, $i, $s);
...
=head2 $record = test::DynamicArrayTypes->new($a, $b, $c, $d, $f, $g, $h, $i, $s);
