...
public class ValueImpl extends MinimalEObjectImpl.Container implements Value
{
   ...
   * @ordered
   */
  protected EList<ValueElement> elements;
   ...
   * @generated
   */
  public EList<ValueElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<ValueElement>(ValueElement.class, this, ProbeLangPackage.VALUE__ELEMENTS);
    }
    return elements;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case ProbeLangPackage.VALUE__ELEMENTS:
        getElements().clear();
        getElements().addAll((Collection<? extends ValueElement>)newValue);
        return;
    }
