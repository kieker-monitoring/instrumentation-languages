 ...
 * </p>
 * <ul>
 *   <li>{@link kieker.develop.semantics.annotations.impl.TechnologyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TechnologyImpl extends MinimalEObjectImpl.Container implements Technology {
	...
	protected EClass eStaticClass() {
		return AnnotationsPackage.Literals.TECHNOLOGY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnnotationsPackage.TECHNOLOGY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AnnotationsPackage.TECHNOLOGY__NAME:
				return getName();
		}
