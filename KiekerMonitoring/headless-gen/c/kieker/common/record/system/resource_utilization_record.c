...
#include <stdlib.h>
#include <kieker.h>
#include "c/kieker/common/record/system/kieker_common_record_system_resource_utilization_record.h"
...
int kieker_common_record_system_resource_utilization_record_serialize(char *buffer, const int id, const int offset, const kieker_common_record_system_resource_utilization_record value) {
	...
	length += kieker_serialize_string(buffer,offset,resourceName);
	length += kieker_serialize_double(buffer,offset,utilization);
	return length;
}
