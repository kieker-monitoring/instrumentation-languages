  ...
  public String createConstantValue(final Literal value) {
    ...
    if (!_matched) {
      if (value instanceof StringLiteral) {
        final StringLiteral _stringLiteral = (StringLiteral)value;
        _matched=true;
        return ((StringLiteral) _stringLiteral).getValue();
      }
    }
    if (!_matched) {
      if (value instanceof FloatLiteral) {
        final FloatLiteral _floatLiteral = (FloatLiteral)value;
        _matched=true;
        Float _value = ((FloatLiteral) _floatLiteral).getValue();
        return _value.toString();
      }
    }
    if (!_matched) {
      if (value instanceof IntLiteral) {
        final IntLiteral _intLiteral = (IntLiteral)value;
        _matched=true;
        int _value = ((IntLiteral) _intLiteral).getValue();
        return Integer.valueOf(_value).toString();
      }
    }
    if (!_matched) {
      if (value instanceof ConstantLiteral) {
        final ConstantLiteral _constantLiteral = (ConstantLiteral)value;
        _matched=true;
        Constant _value = ((ConstantLiteral) _constantLiteral).getValue();
