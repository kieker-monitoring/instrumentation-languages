...
#include <stdlib.h>
#include <kieker.h>
#include "c/test/test_static_deep_array_types.h"
 ...
 */
/*
 * Serialize an StaticDeepArrayTypes and return the size of the written structure.
 *
 ...
 */
int test_static_deep_array_types_serialize(char *buffer, const int id, const int offset, const test_static_deep_array_types value) {
	int length = 0;
