...
package test::StaticDeepArrayTypes;

=head1 NAME

test::StaticDeepArrayTypes 

=head1 SYNOPSIS

 my $record = test::StaticDeepArrayTypes->new($a, $b, $c, $d, $f, $g, $h, $i, $s);
...
=head2 $record = test::StaticDeepArrayTypes->new($a, $b, $c, $d, $f, $g, $h, $i, $s);
