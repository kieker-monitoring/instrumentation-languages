 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.se.instrumentation.al.mapping.impl.CollectionTypeImpl#getElementType <em>Element Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionTypeImpl extends TypeImpl implements CollectionType {
	...
	protected EClass eStaticClass() {
		return MappingPackage.Literals.COLLECTION_TYPE;
	}
		...
		if (elementType != null && elementType.eIsProxy()) {
			...
			if (elementType != oldElementType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MappingPackage.COLLECTION_TYPE__ELEMENT_TYPE, oldElementType, elementType));
			}
		}
		return elementType;
	}
	...
	public void setElementType(Type newElementType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.COLLECTION_TYPE__ELEMENT_TYPE, oldElementType, elementType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingPackage.COLLECTION_TYPE__ELEMENT_TYPE:
