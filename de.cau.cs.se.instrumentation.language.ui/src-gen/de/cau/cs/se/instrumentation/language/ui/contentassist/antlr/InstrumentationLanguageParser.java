		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getRecordsAssignment_5(), "rule__Model__RecordsAssignment_5");
					...
					put(grammarAccess.getRecordAccess().getPropertiesAssignment_3(), "rule__Record__PropertiesAssignment_3");
