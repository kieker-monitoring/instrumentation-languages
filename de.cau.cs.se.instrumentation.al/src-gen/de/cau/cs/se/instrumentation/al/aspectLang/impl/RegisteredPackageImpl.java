...
public class RegisteredPackageImpl extends MinimalEObjectImpl.Container implements RegisteredPackage
{
  ...
  {
    return AspectLangPackage.Literals.REGISTERED_PACKAGE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AspectLangPackage.REGISTERED_PACKAGE__NAME, oldName, name));
  }
  ...
  public EPackage getEPackage()
  {
    if (ePackage != null && ePackage.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AspectLangPackage.REGISTERED_PACKAGE__EPACKAGE, oldEPackage, ePackage));
      }
    }
    return ePackage;
  }
  ...
  public void setEPackage(EPackage newEPackage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AspectLangPackage.REGISTERED_PACKAGE__EPACKAGE, oldEPackage, ePackage));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AspectLangPackage.REGISTERED_PACKAGE__NAME:
        return getName();
      case AspectLangPackage.REGISTERED_PACKAGE__EPACKAGE:
