 ...
 *   <li>{@link de.cau.cs.se.instrumentation.al.aspectLang.Query#getModifier <em>Modifier</em>}</li>
 *   <li>{@link de.cau.cs.se.instrumentation.al.aspectLang.Query#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link de.cau.cs.se.instrumentation.al.aspectLang.Query#getMethod <em>Method</em>}</li>
 *   <li>{@link de.cau.cs.se.instrumentation.al.aspectLang.Query#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Query extends EObject
{
   ...
   * @see de.cau.cs.se.instrumentation.al.aspectLang.AspectLangPackage#getQuery_Modifier()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.se.instrumentation.al.aspectLang.Query#getModifier <em>Modifier</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.se.instrumentation.al.aspectLang.AspectLangPackage#getQuery_ReturnType()
   * @model
   * @generated
   */
  Type getReturnType();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.se.instrumentation.al.aspectLang.Query#getReturnType <em>Return Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.se.instrumentation.al.aspectLang.Query#getMethod <em>Method</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.se.instrumentation.al.aspectLang.AspectLangPackage#getQuery_Parameter()
   * @model containment="true"
   * @generated
   */
