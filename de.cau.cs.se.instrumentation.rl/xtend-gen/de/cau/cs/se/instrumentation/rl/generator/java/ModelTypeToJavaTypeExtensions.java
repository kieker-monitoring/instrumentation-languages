...
public class ModelTypeToJavaTypeExtensions implements IModelTypeToTargetTypeExtensions {
  public ModelTypeToJavaTypeExtensions() {
  }
   ...
   */
  public String createPrimitiveWrapperTypeName(final EClassifier classifier) {
    String _switchResult = null;
    String _name = classifier.getName();
    boolean _matched = false;
    if (!_matched) {
