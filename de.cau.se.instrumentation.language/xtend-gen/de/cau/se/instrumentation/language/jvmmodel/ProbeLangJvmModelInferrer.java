package de.cau.se.instrumentation.language.jvmmodel;
...
public class ProbeLangJvmModelInferrer extends AbstractModelInferrer {
  /**
  ...
  public void infer(final EObject element, final Object acceptor, final boolean isPrelinkingPhase) {
    if (element instanceof Model
      ...
      _infer((Model)element, (IAcceptor<JvmDeclaredType>)acceptor, isPrelinkingPhase);
      return;
