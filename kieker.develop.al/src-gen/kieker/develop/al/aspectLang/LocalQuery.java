 ...
 * </p>
 * <ul>
 *   <li>{@link kieker.develop.al.aspectLang.LocalQuery#getLocationQuery <em>Location Query</em>}</li>
 *   <li>{@link kieker.develop.al.aspectLang.LocalQuery#getProperty <em>Property</em>}</li>
 *   <li>{@link kieker.develop.al.aspectLang.LocalQuery#getTypeof <em>Typeof</em>}</li>
 * </ul>
 *
 * @see kieker.develop.al.aspectLang.AspectLangPackage#getLocalQuery()
 * @model
 * @generated
 */
public interface LocalQuery extends ConstraintElement
{
   ...
   * @see kieker.develop.al.aspectLang.AspectLangPackage#getLocalQuery_LocationQuery()
  ...
  /**
   * Sets the value of the '{@link kieker.develop.al.aspectLang.LocalQuery#getLocationQuery <em>Location Query</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see kieker.develop.al.aspectLang.AspectLangPackage#getLocalQuery_Property()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link kieker.develop.al.aspectLang.LocalQuery#getProperty <em>Property</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see kieker.develop.al.aspectLang.AspectLangPackage#getLocalQuery_Typeof()
   * @model containment="true"
   * @generated
   */
  Typeof getTypeof();
  ...
  /**
   * Sets the value of the '{@link kieker.develop.al.aspectLang.LocalQuery#getTypeof <em>Typeof</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
