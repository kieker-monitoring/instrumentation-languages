...
public class RecordTypeGenerator extends AbstractRecordTypeGenerator {
  ...
  public CharSequence createContent(final RecordType type, final String author, final String version) {
    CharSequence _xblockexpression = null;
    {
      ...
      if (_and) {
        ...
        final Function1<TemplateType, CharSequence> _function = new Function1<TemplateType, CharSequence>() {
          public CharSequence apply(final TemplateType i) {
          ...
          if (_equals_3) {
            ...
            final Function1<Property, String> _function_1 = new Function1<Property, String>() {
              public String apply(final Property property) {
                return RecordTypeGenerator.this.createSizeConstant(property, type);
              }
            };
      ...
      if (_notEquals_2) {
        ...
        String _join_6 = IterableExtensions.join(_map_8, ", ");
      ...
      _builder.newLine();
      {
        ...
        if (_not_4) {
          ...
          _builder.newLine();
          _builder.append("\t");
          _builder.append("public void registerStrings(final IRegistry<String> stringRegistry) {");
          _builder.newLine();
          _builder.append("\t\t");
          final Function1<Property, Boolean> _function_13 = new Function1<Property, Boolean>() {
          ...
          final Iterable<Property> filteredProperties = IterableExtensions.<Property>filter(allDataProperties, _function_13);
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          final Function1<Property, CharSequence> _function_14 = new Function1<Property, CharSequence>() {
            public CharSequence apply(final Property property) {
              return RecordTypeGenerator.this.createStringPropertyRegistration(property);
            }
          };
          Iterable<CharSequence> _map_12 = IterableExtensions.<Property, CharSequence>map(filteredProperties, _function_14);
          ...
          _builder.newLine();
          _builder.append("\t\t");
          final Function1<Property, CharSequence> _function_15 = new Function1<Property, CharSequence>() {
            public CharSequence apply(final Property property) {
              return RecordTypeGenerator.this.createPropertyBinarySerialization(property);
            }
          };
          List<CharSequence> _map_13 = ListExtensions.<Property, CharSequence>map(allDataProperties, _function_15);
      ...
      final Function1<Property, CharSequence> _function_16 = new Function1<Property, CharSequence>() {
        public CharSequence apply(final Property property) {
          return RecordTypeGenerator.this.createPropertyGetter(property);
        }
      };
      List<CharSequence> _map_14 = ListExtensions.<Property, CharSequence>map(_collectAllGetterDeclarationProperties, _function_16);
  ...
  private CharSequence createStringPropertyRegistration(final Property property) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("stringRegistry.get(this.get");
    String _name = property.getName();
    String _firstUpper = StringExtensions.toFirstUpper(_name);
    _builder.append(_firstUpper, "");
    _builder.append("());");
    _builder.newLineIfNotEmpty();
    _builder.append("/* TODO change interface of string registry to write the following");
    _builder.newLine();
    _builder.append("if (!stringRegistry.contains(this.get");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("stringRegistry.add(this.get");
  ...
  private CharSequence createImplements(final RecordType type) {
    ...
    if (_and) {
      ...
      final Function1<TemplateType, String> _function = new Function1<TemplateType, String>() {
        public String apply(final TemplateType iface) {
    ...
    try {
      ...
      if (!_matched) {
        if (literal instanceof StringLiteral) {
          ...
          _switchResult = this.protectKeywords(_createConstantName);
        }
      }
      if (!_matched) {
  ...
  private CharSequence createDefaultConstant(final Constant constant) {
    ...
    String _createTypeName = this.createTypeName(_type);
    _builder.append(_createTypeName, "");
    _builder.append(" ");
   ...
   * @returns a java type name
   */
  private String createArrayTypeName(final Classifier classifier) {
    String _xblockexpression = null;
    {
      EClassifier _class_ = classifier.getClass_();
