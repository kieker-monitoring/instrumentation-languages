 ...
 * </p>
 * <ul>
 *   <li>{@link kieker.develop.rl.recordLang.ForeignKey#getRecordType <em>Record Type</em>}</li>
 *   <li>{@link kieker.develop.rl.recordLang.ForeignKey#getPropertyRef <em>Property Ref</em>}</li>
 * </ul>
 *
 * @see kieker.develop.rl.recordLang.RecordLangPackage#getForeignKey()
 * @model
 * @generated
 */
public interface ForeignKey extends EObject
{
   ...
   * @see kieker.develop.rl.recordLang.RecordLangPackage#getForeignKey_RecordType()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link kieker.develop.rl.recordLang.ForeignKey#getRecordType <em>Record Type</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see kieker.develop.rl.recordLang.RecordLangPackage#getForeignKey_PropertyRef()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link kieker.develop.rl.recordLang.ForeignKey#getPropertyRef <em>Property Ref</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
