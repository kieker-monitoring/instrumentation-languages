...
{ before(grammarAccess.getModelAccess().getRecordsRecordParserRuleCall_5_0()); }
	ruleRecord{ after(grammarAccess.getModelAccess().getRecordsRecordParserRuleCall_5_0()); }
)
...
{ before(grammarAccess.getRecordAccess().getPropertiesPropertyParserRuleCall_3_0()); }
	ruleProperty{ after(grammarAccess.getRecordAccess().getPropertiesPropertyParserRuleCall_3_0()); }
)
